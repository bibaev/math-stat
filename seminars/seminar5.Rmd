...
for(n in ns) {
  experiment(n, names = c("Anderson-Darling", "Lilliefors", "Kolmogorov-Smirnov true", "Kolmogorov-Smirnov estimate", "Shapiro-Wilk "), tests = c(ad.test, lillie.test, ks_true, ks_estimated, shapiro.test))
}
```
### Часть 2
